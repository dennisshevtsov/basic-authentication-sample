...
public sealed class BasicAuthorizationHandler(
  IOptionsMonitor<BasicAuthorizationOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
  : AuthenticationHandler<BasicAuthorizationOptions>(options, logger, encoder, clock)
{
  ...
  protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
  {
    ...
    if (authenticationHeaderValue.Scheme != BasicAuthorizationDefaults.AuthenticationScheme)
    {
    ...
    AuthenticationTicket authenticationTicket = new(principal, BasicAuthorizationDefaults.AuthenticationScheme);
